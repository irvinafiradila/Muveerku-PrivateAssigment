package id.sch.smktelkom_mlg.privateassigment.xirpl514.muveerku.adapter;
...
import id.sch.smktelkom_mlg.privateassigment.xirpl514.muveerku.R;
        ...
        public ViewHolder(View itemView) {
            ...
            /*itemView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    List<String> sort = result.sortBysAvailable;
                    mISourceAdapter.showArticles(result.id, result.name, sort.get(sort.size() - 1));
                }
            });*/
        }
    }
